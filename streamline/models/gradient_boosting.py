...
class GBClassifier(BaseModel, ABC):
    ...
    def __init__(self, cv_folds=3, scoring_metric='balanced_accuracy',
        ...
        super().__init__(GB, "Gradient Boosting", cv_folds=cv_folds, scoring_metric=scoring_metric, metric_direction=metric_direction, random_state=random_state, cv=cv, n_jobs=n_jobs,
